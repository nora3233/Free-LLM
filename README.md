...
- **Earn recognition** on the [Hall of Fame](https://free-llm.com/hall-of-fame.php) leaderboard
...
1. **Add a provider** — use the [submit form](https://free-llm.com/submit.php) on the website or open a PR.
2. **Fix data** — spot something outdated? [Propose an edit](https://free-llm.com/edit.php) directly.
